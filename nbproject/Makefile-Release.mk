...
OBJECTFILES= \
	...
	${OBJECTDIR}/argvparser-20060124/tests.o \
...
${OBJECTDIR}/argvparser-20060124/tests.o: nbproject/Makefile-${CND_CONF}.mk argvparser-20060124/tests.cpp 
	${MKDIR} -p ${OBJECTDIR}/argvparser-20060124
	${RM} $@.d
	$(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -MMD -MP -MF $@.d -o ${OBJECTDIR}/argvparser-20060124/tests.o argvparser-20060124/tests.cpp
...
${TESTDIR}/tests/CoveredSetPartitionRunner.o: tests/CoveredSetPartitionRunner.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CoveredSetPartitionRunner.o tests/CoveredSetPartitionRunner.cpp


${TESTDIR}/tests/CoveredSetPatitionTest.o: tests/CoveredSetPatitionTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -MMD -MP -MF $@.d -o ${TESTDIR}/tests/CoveredSetPatitionTest.o tests/CoveredSetPatitionTest.cpp


${TESTDIR}/tests/FunctionRunner.o: tests/FunctionRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -MMD -MP -MF $@.d -o ${TESTDIR}/tests/FunctionRunner.o tests/FunctionRunner.cpp


${TESTDIR}/tests/FunctionTest.o: tests/FunctionTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -MMD -MP -MF $@.d -o ${TESTDIR}/tests/FunctionTest.o tests/FunctionTest.cpp


${TESTDIR}/tests/HasseRunner.o: tests/HasseRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -MMD -MP -MF $@.d -o ${TESTDIR}/tests/HasseRunner.o tests/HasseRunner.cpp


${TESTDIR}/tests/HasseTest.o: tests/HasseTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -MMD -MP -MF $@.d -o ${TESTDIR}/tests/HasseTest.o tests/HasseTest.cpp


${TESTDIR}/tests/SynthesizerRunner.o: tests/SynthesizerRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -MMD -MP -MF $@.d -o ${TESTDIR}/tests/SynthesizerRunner.o tests/SynthesizerRunner.cpp


${TESTDIR}/tests/SynthesizerTest.o: tests/SynthesizerTest.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} $@.d
	$(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -MMD -MP -MF $@.d -o ${TESTDIR}/tests/SynthesizerTest.o tests/SynthesizerTest.cpp
...
${OBJECTDIR}/argvparser-20060124/tests_nomain.o: ${OBJECTDIR}/argvparser-20060124/tests.o argvparser-20060124/tests.cpp 
	${MKDIR} -p ${OBJECTDIR}/argvparser-20060124
	@NMOUTPUT=`${NM} ${OBJECTDIR}/argvparser-20060124/tests.o`; \
	if (echo "$$NMOUTPUT" | ${GREP} '|main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T main$$') || \
	   (echo "$$NMOUTPUT" | ${GREP} 'T _main$$'); \
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Iconductors -Ialgorithms -I. -Isupport -Isynthesizers -Iargvparser-20060124 `pkg-config --cflags yaml-cpp` -std=c++11   -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/argvparser-20060124/tests_nomain.o argvparser-20060124/tests.cpp;\
	else  \
	    ${CP} ${OBJECTDIR}/argvparser-20060124/tests.o ${OBJECTDIR}/argvparser-20060124/tests_nomain.o;\
	fi
